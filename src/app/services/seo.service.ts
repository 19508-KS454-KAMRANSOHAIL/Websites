...
export class SeoService {
  ...
  setBlogPostMetaTags(title: string, description: string, image: string, url: string, author: string, publishDate: string) {
    ...
    this.meta.updateTag({ property: 'article:published_time', content: publishDate });
