...
export const localBusinessSchemas = {
  ...
  nationwide: {
    ...
    "description": "Digital transformation and custom software development solutions for American businesses",
  ...
  silicon_valley: {
    ...
    "description": "Custom software development and digital transformation for Silicon Valley tech companies"
  },
  ...
  new_york: {
    ...
    "description": "Enterprise software development and consulting for NYC businesses"
  },
  ...
  texas: {
    ...
    "description": "Software solutions and digital transformation for Texas enterprises"
  },
  ...
  healthcare: {
    ...
    "description": "Specializing in HIPAA-compliant software solutions for healthcare providers and institutions",
    "url": "https://websiteservice619.netlify.app",
    "areaServed": "US",
    "knowsAbout": [
      "HIPAA Compliance",
  ...
  fintech: {
    ...
    "description": "Custom fintech solutions and digital banking platform development",
    "url": "https://websiteservice619.netlify.app",
    "areaServed": "US",
    "knowsAbout": [
      "Payment Processing",
  ...
  ecommerce: {
    ...
    "description": "E-commerce platform development and optimization for online retailers",
    "url": "https://websiteservice619.netlify.app",
    "areaServed": "US",
    "knowsAbout": [
  ...
  manufacturing: {
    ...
    "description": "Enterprise software solutions for manufacturing and industrial operations",
    "url": "https://websiteservice619.netlify.app",
    "areaServed": "US",
    "knowsAbout": [
      "ERP Systems",
...
export const serviceProviderSchemas = {
  digital_transformation: {
    ...
    "areaServed": "US",
    "description": "Helping American businesses modernize legacy systems and adopt cloud-native architectures",
  ...
  custom_development: {
    ...
    "areaServed": "US",
    "description": "Full-stack enterprise application development tailored to your business needs",
    "url": "https://websiteservice619.netlify.app/services",
    "priceRange": "$$$$",
    "knowsAbout": [
  ...
  cloud_migration: {
    ...
    "areaServed": "US",
    "description": "Strategic cloud migration planning and execution for maximum efficiency",
    "url": "https://websiteservice619.netlify.app/services",
    "priceRange": "$$$$",
    "knowsAbout": [
      "AWS Migration",
  ...
  technical_consulting: {
    ...
    "areaServed": "US",
    "description": "Expert technical guidance for software architecture and technology strategy",
    "url": "https://websiteservice619.netlify.app/services",
    "priceRange": "$$$$"
  }
};
...
export function getEventSchema(event: {
  ...
  return {
    ...
    "image": event.image || "https://websiteservice619.netlify.app/assets/og-image.jpg",
